        ...
        <div className="card overflow-hidden p-0">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left py-3 px-4 font-medium text-gray-500">Candidate ID</th>
            ...
            <tbody>
              {candidates.map((candidate) => (
                <tr key={candidate.id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-3 px-4 font-mono text-xs">{candidate.candidate_id}</td>
                  <td className="py-3 px-4 font-medium text-gray-900">{candidate.name}</td>
                  <td className="py-3 px-4 text-gray-500">{candidate.email || '-'}</td>
                  <td className="py-3 px-4 text-gray-500">{candidate.phone || '-'}</td>
                  <td className="py-3 px-4 text-gray-500">{candidate.date_of_birth || '-'}</td>
